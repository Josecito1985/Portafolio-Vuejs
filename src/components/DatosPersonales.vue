...
const presentacion = 'Hola, Bienvenidos a mi portafolio de proyectos. Soy un estudiante de la tecnicatura en programación con experiencia en el desarrollo de aplicaciones web y móviles.';
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://www.linkedin.com/in/jose-gomez-0b42b71a9/' },
  { id: 2, name: 'Instagram', src: instagram, url: 'https://www.instagram.com/josehgomez85/' },
  { id: 3, name: 'github', src: github, url: 'https://github.com/Josecito1985' },
  { id: 4, name: 'curriculum', src: cv, url: '' },
];
const telefono = '+54 362 4895511';
</script>
